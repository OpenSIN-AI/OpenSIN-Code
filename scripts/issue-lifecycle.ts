...
export const lifecycle = [
  {
    ...
    nudge: "This doesn't appear to be about [OpenSIN Code](https://github.com/opensin-ai/opensin-code). For general OpenSIN support, visit [support.opensin.ai](https://support.opensin.ai).",
  },
  {
    label: "needs-repro",
    days: 7,
