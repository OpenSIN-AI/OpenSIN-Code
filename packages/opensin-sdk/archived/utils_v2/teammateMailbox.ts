 ...
 *
 * Each teammate has an inbox file at .opensin/teams/{team_name}/inboxes/{agent_name}.json
 ...
 * Structure: ~/.opensin/teams/{team_name}/inboxes/{agent_name}.json
 */
 ...
 * @param teamName - Optional team name (defaults to OPENSIN_CODE_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's OPENSIN_CODE_AGENT_ID */
  workerId: string
  /** Worker's OPENSIN_CODE_AGENT_NAME */
  workerName: string
  /** Worker's OPENSIN_CODE_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to OPENSIN_CODE_TEAM_NAME env var)
