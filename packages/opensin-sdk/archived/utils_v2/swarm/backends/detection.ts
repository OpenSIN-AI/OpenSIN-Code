...
/**
 * Captured at module load time to detect if the user started OpenSIN from within tmux.
 ...
 * because Shell.ts overrides TMUX when OpenSIN's socket is initialized.
 *
...
export async function isInsideTmux(): Promise<boolean> {
  ...
  // This tells us if the user started OpenSIN from within their tmux session
