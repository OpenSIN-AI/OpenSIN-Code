...
export function getAgentModel(
  ...
  if (process.env.OPENSIN_CODE_SUBAGENT_MODEL) {
    return parseUserSpecifiedModel(process.env.OPENSIN_CODE_SUBAGENT_MODEL)
  }
  ...
  // region prefix (e.g., "eu.opensin.…"), we preserve it instead of overwriting
 ...
 * See https://github.com/opensins/opensin-code/issues/30815.
 *
