 ...
 *
 * The vulnerability was demonstrated in HackerOne report #3086545 targeting OpenSIN Desktop's
 * MCP (Model Context Protocol) implementation, where attackers could inject hidden instructions
 * using Unicode Tag characters that would be executed by OpenSIN but remain invisible to users.
 *
