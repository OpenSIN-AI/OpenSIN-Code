 ...
 *
 * When true:
 * - `find` and `grep` in OpenSIN's Bash shell are shadowed by shell functions
 ...
 * - Prompt guidance steering OpenSIN away from find/grep is omitted
 *
...
export function hasEmbeddedSearchTools(): boolean {
  ...
  const e = process.env.OPENSIN_CODE_ENTRYPOINT
  return (
