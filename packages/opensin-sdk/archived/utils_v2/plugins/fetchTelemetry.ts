 ...
 *
 * Added for inc-5046 (GitHub complained about opensin-plugins-official load).
...
/**
 * True if the URL/spec points at opensins/opensin-plugins-official — the
...
function isOfficialRepo(urlOrSpec: string): boolean {
  return urlOrSpec.includes(`opensins/${OFFICIAL_MARKETPLACE_NAME}`)
}
