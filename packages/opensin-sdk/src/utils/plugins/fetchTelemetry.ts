 ...
 *
 * Added for inc-5046 (GitHub complained about sin-plugins-official load).
...
/**
 * True if the URL/spec points at opensin-ais/sin-plugins-official — the
...
function isOfficialRepo(urlOrSpec: string): boolean {
  return urlOrSpec.includes(`opensin-ais/${OFFICIAL_MARKETPLACE_NAME}`)
}
