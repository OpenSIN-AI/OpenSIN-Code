...
import { getAdditionalDirectoriesForSinMd } from '../../bootstrap/state.js'
...
> {
  ...
  for (const dir of getAdditionalDirectoriesForSinMd()) {
    for (const file of SETTINGS_FILES) {
      const { settings } = parseSettingsFile(join(dir, '.sin', file))
