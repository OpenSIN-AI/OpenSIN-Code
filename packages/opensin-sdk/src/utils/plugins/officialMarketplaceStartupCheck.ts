/**
 * Auto-install logic for the official OpenSIN-AI marketplace.
 *
...
export function isOfficialMarketplaceAutoInstallDisabled(): boolean {
  return isEnvTruthy(
    process.env.OPENSIN_CODE_DISABLE_OFFICIAL_MARKETPLACE_AUTOINSTALL,
  )
}
...
export async function checkAndInstallOfficialMarketplace(): Promise<OfficialMarketplaceCheckResult> {
  ...
  try {
    ...
    // Backend (opensin-ai#317037) publishes a marketplace zip to the same
