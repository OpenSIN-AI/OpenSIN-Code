 ...
 * Sin plugins statistics repository. The cache is refreshed if older
 * than 24 hours.
 *
 * Cache location: ~/.sin/plugins/install-counts-cache.json
 */
...
const INSTALL_COUNTS_URL =
  'https://raw.githubusercontent.com/opensin-ais/sin-plugins-official/refs/heads/stats/stats/plugin-installs.json'
