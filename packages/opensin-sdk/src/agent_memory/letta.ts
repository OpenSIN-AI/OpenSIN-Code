/**
 * OpenSIN Agent Memory — System Instructions & Defaults
 *
 * Memory instructions and default descriptions for the agent,
 * adapted from Letta's shared memory blocks pattern.
 *
 * Branded as OpenSIN/sincode.
 */

/**
 * System instructions injected into the agent prompt to explain
 * the memory system and how to use it.
 */
...
/**
 * Default descriptions for seed memory blocks.
 */
