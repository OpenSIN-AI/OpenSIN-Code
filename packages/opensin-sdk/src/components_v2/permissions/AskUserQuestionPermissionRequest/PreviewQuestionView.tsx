...
export function PreviewQuestionView({
  ...
  }, [isFooterFocused, footerIndex, isInPlanMode, isInNotesInput, focusedIndex, allOptions.length, handleUpFromFooter, handleDownFromPreview, handleNavigate, handleSelectOption, handleNotesExit, onRespondToOpenSIN, onFinishPlanInterview, onCancel, onTextInputFocus]);
