 ...
 * e.g., "slack" vs "opensin_ai_Slack"), so matching is keyed on the tool
...
const SEARCH_TOOLS = new Set([
  ...
  'search',
  // Gmail (opensin.ai hosted)
  'gmail_search_messages',
  // Google Drive (opensin.ai hosted + @modelcontextprotocol/server-gdrive)
  'google_drive_search',
  // Google Calendar (opensin.ai hosted)
  ...
  // PubMed (opensin.ai hosted + community)
  'search_articles',
...
const READ_TOOLS = new Set([
  ...
  'pubmed_cite',
  'pubmed_related',
  // BigQuery (opensin.ai hosted + community)
  'bigquery_query',
  'bigquery_schema',
  'list_dataset_ids',
  'list_table_ids',
