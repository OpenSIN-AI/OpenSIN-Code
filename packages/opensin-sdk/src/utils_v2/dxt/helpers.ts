import type { McpbManifest } from '@opensin-ai/mcpb'
 ...
 *
 * Lazy-imports @opensin-ai/mcpb: that package uses zod v3 which eagerly
...
export async function validateManifest(
  ...
  const { McpbManifestSchema } = await import('@opensin-ai/mcpb')
