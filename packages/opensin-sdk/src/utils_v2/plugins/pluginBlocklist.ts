 ...
 * for UI reason/text only. If re-introduced, serve from downloads.opensin.ai.
 */
 ...
 * @param marketplaceName The marketplace name suffix (e.g. "opensin-plugins-official")
