 ...
 *
 * These helpers identify whether this OpenSIN Code instance is running as a
...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.OPENSIN_CODE_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our OPENSIN_CODE_AGENT_ID matches the leadAgentId, OR
 *    - We have no OPENSIN_CODE_AGENT_ID set (backwards compat: the original
