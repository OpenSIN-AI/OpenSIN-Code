 ...
 *
 * Parses `opensin-cli://open` URIs. All parameters are optional:
 ...
 * Examples:
 *   opensin-cli://open
 *   opensin-cli://open?q=hello+world
 *   opensin-cli://open?q=fix+tests&repo=owner/repo
 *   opensin-cli://open?cwd=/path/to/project
 *
...
export const DEEP_LINK_PROTOCOL = 'opensin-cli'
 ...
 * the `cd /d <cwd> && <opensin.exe> --deep-link-origin ... --prefill "<q>"`
...
/**
 * Parse a opensin-cli:// URI into a structured action.
 *
...
/**
 * Build a opensin-cli:// deep link URL.
 */
