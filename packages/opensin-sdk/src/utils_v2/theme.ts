...
export type Theme = {
  ...
  bashBorder: string
  opensin: string
  opensinShimmer: string // Lighter version of opensin color for shimmer effect
  opensinBlue_FOR_SYSTEM_SPINNER: string
  opensinBlueShimmer_FOR_SYSTEM_SPINNER: string
  permission: string
...
const lightTheme: Theme = {
  ...
  opensin: 'rgb(215,119,87)', // OpenSIN orange
  opensinShimmer: 'rgb(245,149,117)', // Lighter opensin orange for shimmer effect
  opensinBlue_FOR_SYSTEM_SPINNER: 'rgb(87,105,247)', // Medium blue for system spinner
  opensinBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(117,135,255)', // Lighter blue for system spinner shimmer
  ...
  briefLabelOpenSIN: 'rgb(215,119,87)', // Brand orange
...
const lightAnsiTheme: Theme = {
  ...
  opensin: 'ansi:redBright',
  opensinShimmer: 'ansi:yellowBright',
  opensinBlue_FOR_SYSTEM_SPINNER: 'ansi:blue',
  opensinBlueShimmer_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
  ...
  briefLabelOpenSIN: 'ansi:redBright',
...
const darkAnsiTheme: Theme = {
  ...
  opensin: 'ansi:redBright',
  opensinShimmer: 'ansi:yellowBright',
  opensinBlue_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
  opensinBlueShimmer_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
...
const lightDaltonizedTheme: Theme = {
  ...
  opensin: 'rgb(255,153,51)', // Orange adjusted for deuteranopia
  opensinShimmer: 'rgb(255,183,101)', // Lighter orange for shimmer effect
  opensinBlue_FOR_SYSTEM_SPINNER: 'rgb(51,102,255)', // Bright blue for system spinner
  opensinBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(101,152,255)', // Lighter bright blue for system spinner shimmer
  ...
  fastModeShimmer: 'rgb(255,150,50)', // Lighter orange for shimmer
  briefLabelYou: 'rgb(37,99,235)', // Blue
  briefLabelOpenSIN: 'rgb(255,153,51)', // Orange adjusted for deuteranopia (matches opensin)
  rainbow_red: 'rgb(235,95,87)',
  rainbow_orange: 'rgb(245,139,87)',
  rainbow_yellow: 'rgb(250,195,95)',
  rainbow_green: 'rgb(145,200,130)',
...
const darkTheme: Theme = {
  ...
  opensin: 'rgb(215,119,87)', // OpenSIN orange
  opensinShimmer: 'rgb(235,159,127)', // Lighter opensin orange for shimmer effect
  opensinBlue_FOR_SYSTEM_SPINNER: 'rgb(147,165,255)', // Blue for system spinner
  opensinBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(177,195,255)', // Lighter blue for system spinner shimmer
...
const darkDaltonizedTheme: Theme = {
  ...
  opensin: 'rgb(255,153,51)', // Orange adjusted for deuteranopia
  opensinShimmer: 'rgb(255,183,101)', // Lighter orange for shimmer effect
  opensinBlue_FOR_SYSTEM_SPINNER: 'rgb(153,204,255)', // Light blue for system spinner
  opensinBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(183,224,255)', // Lighter blue for system spinner shimmer
