import type { SelectionArea, UIElement } from "./types.js";
  ...
  elementToUIElement(element: HTMLElement): UIElement {
    ...
    return {
      ...
      parentElement: element.parentElement
        ? { id: element.parentElement.id || `el-${Date.now()}`, tagName: element.parentElement.tagName.toLowerCase() } as UIElement
        : null,
      children: [],
    };
  }
