...
const BUILTIN_PRESETS: Record<string, RulePreset> = {
  recommended: {
    name: "Recommended",
...
export class RulesManager {
  ...
  private projectRules: Map<string, LintRule> = new Map()
  private defaultSeverity: LintSeverity
  ...
  private generateDescription(ruleId: string): string {
  ...
  private applyPresets(presetNames: string[]): void {
  ...
  private mergeCustomRules(customRules: Record<string, RuleSeverity>): void {
