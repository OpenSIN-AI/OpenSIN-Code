...
```
{
  ...
  "prompt": "You are analyzing an OpenSIN Code conversation to find behaviors the user wants to prevent.
...
Use the current working directory (where Sin was started) as the base path.
