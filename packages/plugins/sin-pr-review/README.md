...
Simply ask questions that match an agent's focus area, and OpenSIN Code will automatically trigger the appropriate agent:
...
OpenSIN Code may proactively use these agents based on context:
...
- User agents: `~/.opencode/agents/`
- Project agents: `.opencode/agents/` in OpenSIN-Code
