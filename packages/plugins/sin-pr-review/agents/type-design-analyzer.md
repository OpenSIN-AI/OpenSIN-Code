...
<example>
Context: User is writing code that introduces a new UserAccount type and wants to ensure it has well-designed invariants.
...
<example>
Context: User is creating a pull request and wants to review all newly added types.
