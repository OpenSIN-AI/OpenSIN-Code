...
export async function handleAgentCreateCommand(name, options) {
    ...
    if (!/^[a-zA-Z][a-zA-Z0-9_-]*$/.test(name)) {
        return {
            success: false,
            message: 'Invalid agent name. Must start with a letter and contain only alphanumeric characters, hyphens, and underscores.',
            files: [],
            outputDir: "",
        };
    }
