export class TemplateGenerator {
    generateAgentScaffold(options) {
        const files = new Map();
        const dir = options.outputDir ?? options.agentName;
        files.set(`${dir}/package.json`, this.#generatePackageJson(options));
        files.set(`${dir}/tsconfig.json`, this.#generateTsConfig());
        files.set(`${dir}/src/index.ts`, this.#generateIndex(options));
        files.set(`${dir}/src/agent.ts`, this.#generateAgentFile(options));
        files.set(`${dir}/README.md`, this.#generateReadme(options));
        return files;
    }
    generateToolTemplate(toolName) {
...
`;
    ...
    generateConfigTemplate(options) {
