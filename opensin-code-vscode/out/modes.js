...
exports.AGENT_MODES = [
    ...
    },
    {
        ...
        systemPrompt: 'You are SIN Code in OpenSIN-Code Proactive Mode. Anticipate user needs, suggest improvements, and work autonomously on background tasks.',
        icon: '⚡'
    }
];
