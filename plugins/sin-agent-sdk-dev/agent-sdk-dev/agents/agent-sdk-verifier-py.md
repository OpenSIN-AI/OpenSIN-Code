...
1. **SDK Installation and Configuration**:
   ...
   - Verify `sin-agent-sdk` is installed (check requirements.txt, pyproject.toml, or pip list)
...
3. **SDK Usage and Patterns**:
   ...
   - Verify correct imports from `sin_agent_sdk` (or appropriate SDK module)
...
2. **Check SDK Documentation Adherence**:
   ...
   - Use WebFetch to reference the official Python SDK docs: https://docs.sin.com/en/api/agent-sdk/python
