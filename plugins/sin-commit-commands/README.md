...
- Let Sin analyze your changes and match your repo's commit style
...
- Sin will analyze the full branch history for the PR description
...
- **Let Sin draft messages**: The commit message analysis learns from your repo's style
...
OpenSIN-AI (support@opensin-ai.com)
