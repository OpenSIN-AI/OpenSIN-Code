...
**Purpose:** Specify which Sin model executes the command
...
- Sin can invoke programmatically
...
**Best practices:**
- Use sparingly (limits Sin's autonomy)
...
**Invalid model name:**
```yaml
model: gpt4  # ❌ Not a valid Sin model
```
