...
# Set up environment
export SIN_PROJECT_DIR="${SIN_PROJECT_DIR:-/tmp/test-project}"
export SIN_PLUGIN_ROOT="${SIN_PLUGIN_ROOT:-$(pwd)}"
export SIN_ENV_FILE="${SIN_ENV_FILE:-/tmp/test-env-$$}"

if [ "$VERBOSE" = true ]; then
  echo "Environment:"
  echo "  SIN_PROJECT_DIR=$SIN_PROJECT_DIR"
  echo "  SIN_PLUGIN_ROOT=$SIN_PLUGIN_ROOT"
  echo "  SIN_ENV_FILE=$SIN_ENV_FILE"
  echo ""
fi
