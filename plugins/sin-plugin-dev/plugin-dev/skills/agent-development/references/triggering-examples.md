...
assistant: "[How Sin should respond before triggering]"
<commentary>
[Explanation of why this agent should be triggered in this scenario]
</commentary>
assistant: "[How Sin triggers the agent - usually 'I'll use the [agent-name] agent...']"
</example>
```
...
**Purpose:** Show what Sin says before launching the agent
...
**Purpose:** Show how Sin invokes the agent
