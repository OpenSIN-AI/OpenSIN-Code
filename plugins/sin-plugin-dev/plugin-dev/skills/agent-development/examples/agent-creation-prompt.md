...
Use this template to generate agents using Sin with the agent creation system prompt.
...
Send this to Sin (with the agent-creation-system-prompt loaded):
...
Tell Sin when the agent should activate:
...
- **Comprehensive**: Sin includes edge cases and quality checks
