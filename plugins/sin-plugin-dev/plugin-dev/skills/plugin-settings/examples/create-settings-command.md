...
This command helps users create a `.sin/my-plugin.local.md` settings file.
...
Use Write tool to create `.sin/my-plugin.local.md`:
...
Tell the user:
- Settings file created at `.sin/my-plugin.local.md`
