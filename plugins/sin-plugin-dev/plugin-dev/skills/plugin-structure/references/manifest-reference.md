...
**Required path**: `.sin-plugin/plugin.json`

The manifest MUST be in the `.sin-plugin/` directory at the plugin root. OpenSIN Code will not recognize plugins without this file in the correct location.
...
```json
{
  "mcpServers": {
    "github": {
      "command": "node",
      "args": ["${SIN_PLUGIN_ROOT}/servers/github-mcp.js"],
      "env": {
