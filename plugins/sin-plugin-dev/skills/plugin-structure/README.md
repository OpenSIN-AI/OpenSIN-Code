...
- Portable path references with `${SIN_PLUGIN_ROOT}`
...
- Ask about "${SIN_PLUGIN_ROOT}" usage
...
Sin loads references and examples only as needed based on the task.
