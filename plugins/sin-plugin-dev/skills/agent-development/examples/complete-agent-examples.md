...
3. Check adherence to project best practices and coding standards from SIN.md
...
5. **Best Practices**:
   - Follow project-specific standards from SIN.md
...
- Missing context (no SIN.md): Apply general best practices
