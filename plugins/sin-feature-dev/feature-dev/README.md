...
Sin: Let me understand what you need...
...
- Sin reads all identified files to build deep understanding
...
**Focus areas:**
- Project guideline compliance (SIN.md)
- Bug detection
- Code quality issues
...
Sid Bidasaria (sbidasaria@opensin-ai.com)
