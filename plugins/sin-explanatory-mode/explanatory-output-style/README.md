...
session. This context instructs Sin to provide brief educational explanations
...
SIN.md, but it is more flexible and allows for distribution through plugins.

Note: Output styles that involve tasks besides software development, are better
expressed as
[subagents](https://docs.sin.com/en/docs/opensin-code/sub-agents), not as
...
- Update the plugin - create a local copy of this plugin to personalize this
  plugin
  - Hint: Ask Sin to read
    https://docs.sin.com/en/docs/opensin-code/plugins.md and set it up for
    you!
