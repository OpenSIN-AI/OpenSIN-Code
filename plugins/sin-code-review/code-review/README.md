...
2. Gathers relevant SIN.md guideline files from the repository
3. Summarizes the pull request changes
4. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for SIN.md compliance
...
- SIN.md compliance checking with explicit guideline verification
...
1. Missing error handling for OAuth callback (SIN.md says "Always handle OAuth errors")
...
3. Inconsistent naming pattern (src/conventions/SIN.md says "Use camelCase for functions")
...
- General quality issues (unless in SIN.md)
...
### Using `/code-review`
- Maintain clear SIN.md files for better compliance checking
- Trust the 80+ confidence threshold - false positives are filtered
- Run on all non-trivial pull requests
- Review agent findings as a starting point for human review
- Update SIN.md based on recurring review patterns
...
- SIN.md files (optional but recommended for guideline checking)
...
- Make SIN.md more specific about what matters
...
- **Write specific SIN.md files**: Clear guidelines = better reviews
- **Include context in PRs**: Helps agents understand intent
- **Use confidence scores**: Issues ≥80 are usually correct
- **Iterate on guidelines**: Update SIN.md based on patterns
...
### Agent architecture
- **2x SIN.md compliance agents**: Redundancy for guideline checks
...
- For SIN.md issues: verifies guideline explicitly mentions it
...
Boris Cherny (boris@opensin-ai.com)
