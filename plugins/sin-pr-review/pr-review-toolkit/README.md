...
Simply ask questions that match an agent's focus area, and Sin will automatically trigger the appropriate agent:
...
Sin may proactively use these agents based on context:
...
- User agents: `~/.sin/agents/`
- Project agents: `.sin/agents/` in sin-cli-internal
