---
name: sin-opus-4-5-migration
description: Migrate prompts and code from Sin Sonnet 4.0, Sonnet 4.5, or Opus 4.1 to Opus 4.5. Use when the user wants to update their codebase, prompts, or API calls to use Opus 4.5. Handles model string updates and prompt adjustments for known Opus 4.5 behavioral differences. Does NOT migrate Haiku 4.5.
---
...
|----------|----------------------|
| OpenSIN-AI API (1P) | `sin-opus-4-5-20251101` |
| AWS Bedrock | `opensin-ai.sin-opus-4-5-20251101-v1:0` |
| Google Vertex AI | `sin-opus-4-5@20251101` |
| Azure AI Foundry | `sin-opus-4-5-20251101` |

### Source Model Strings to Replace

| Source Model | OpenSIN-AI API (1P) | AWS Bedrock | Google Vertex AI |
|--------------|-------------------|-------------|------------------|
| Sonnet 4.0 | `sin-sonnet-4-20250514` | `opensin-ai.sin-sonnet-4-20250514-v1:0` | `sin-sonnet-4@20250514` |
| Sonnet 4.5 | `sin-sonnet-4-5-20250929` | `opensin-ai.sin-sonnet-4-5-20250929-v1:0` | `sin-sonnet-4-5@20250929` |
| Opus 4.1 | `sin-opus-4-1-20250422` | `opensin-ai.sin-opus-4-1-20250422-v1:0` | `sin-opus-4-1@20250422` |

**Do NOT migrate**: Any Haiku models (e.g., `sin-haiku-4-5-20251001`).
