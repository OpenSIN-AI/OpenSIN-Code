...
Refer to our [prompting guide](https://platform.sin.com/docs/en/build-with-sin/prompt-engineering/sin-4-best-practices) for best practices on prompting Sin models.

## Authors

William Hu (whu@opensin-ai.com)
