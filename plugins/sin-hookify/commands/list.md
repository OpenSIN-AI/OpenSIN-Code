...
**Status**: ✅ Active
**File**: .sin/hookify.dangerous-rm.local.md
```
...
2. Or manually create `.sin/hookify.my-rule.local.md` files
...
Check `${SIN_PLUGIN_ROOT}/examples/` for example rule files.
```
